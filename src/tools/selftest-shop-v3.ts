// 상점 구매 자체 확인 — npm run build 뒤 node dist/tools/selftest-shop-v3.js
//
...
import { eggPool, eggPrice, find, slotPrice, speciesPrice, toolPrice } from "../shop/catalog-v3";
...
process.stdout.write("selftest-shop-v3: 통과 (가격·알·도구·파티 칸·종)\n");
