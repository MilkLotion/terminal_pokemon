// 이 명령을 실행한 세션과 그 세션의 펫 — pkmon 실행·내리기·진단(status)이 같은 규칙을 쓴다.
...
//   host      펫이 따라 살고 죽을 세션 프로세스 (CLI LLM 안의 !pkmon 이면 그 CLI). 셸에서 바로 쳤으면 null
//   term      터미널 탭의 셸. guess 는 조상으로 한 첫 추정
//   termFrom  term 을 어디서 알았나 — "ancestors"(확장 기록의 탭이 조상에 있음) · "focus"(포커스된 창의 활성 탭) ·
//             "given"(PKMON_TERM_PID) · "guess"(확장 기록 없음 — 탭 구분이 꺼진다)
