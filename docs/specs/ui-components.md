...
템플릿: 2026-09-24 `Shop Layout` `379:1757`에 진화 분류와 `section/진화` `404:2309`를 더했다. 진화용 도구 24종을 모두 담는다. 도구 절에 있던 진화의돌 하나는 뺐다. 근거는 [진화용 도구 가격과 노출](../work/s5-design-system-v2/plan.md#진화용-도구-가격과-노출)을 따른다.
