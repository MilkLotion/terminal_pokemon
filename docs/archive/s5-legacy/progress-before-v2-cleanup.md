...
> 2026-09-21 정정: 상품·부화 관련 사용자 결정 표기는 직접 근거가 확인되지 않았다. [명칭 출처 정정](../../work/s5-terminology/review.md)을 먼저 확인한다.
...
| S4 해금·상점·진화 | 구현·자동 검사 완료 | 해금, 칸, 새 종, 민트, 먹이, 색, 진화, 모습 선택. 메뉴와 CLI에 연결했다 |
...
별명, 모습 선택, 먹이 판매를 제거한다. 진화의돌은 별도 상품이다.
