...
6. 모듈 책임과 저장 구조는 [모듈 계약](specs/modules.md)으로 정했다. 2026-09-23 거래·저장의 남은 값과 이로치 약의 소모 단위를 정했다. [근거](work/s5-design-system-v2/plan.md#저장과-거래의-남은-값-확정) 2026-09-24 종별 성장 속도·종족값·진화 단계·수집 난이도와 진화 조건을 생성 도구로 만들어 `data/`에 채웠다. [근거](work/s5-design-system-v2/plan.md#콘텐츠-데이터-생성) 2026-09-24 진화용 도구 가격을 공통 150P로 정하고 상점 진화 탭을 만들었다. [근거](work/s5-design-system-v2/plan.md#진화용-도구-가격과-노출) 2026-09-24 알 행동 조건 7개와 대상 58종을 `data/egg-conditions.json`으로 정했다. [근거](work/s5-design-system-v2/plan.md#알-행동-조건의-종별-표) 같은 날 화석 전용 알 태고의돌과 `data/eggs.json`을 더했다. [근거](work/s5-design-system-v2/plan.md#태고의돌-화석-전용-알) 콘텐츠 데이터를 모두 채웠다. 2026-09-24 저장 v3 의 타입·정규화·v2 이전과 거래 실행기, 파일 통로, 파티 명령 5개, 시간 처리, 알 명령 2개, 상점 구매, 가방 사용을 구현했다. [근거](work/s5-design-system-v2/plan.md#가방-사용-명령과-레벨-곡선) [근거](work/s5-design-system-v2/plan.md#상점-구매-명령) [근거](work/s5-design-system-v2/plan.md#알-명령-구현) [근거](work/s5-design-system-v2/plan.md#시간-처리-구현) [근거](work/s5-design-system-v2/plan.md#파티-배치교체보관-명령) [근거](work/s5-design-system-v2/plan.md#저장-v3-파일-통로) [근거](work/s5-design-system-v2/plan.md#거래-실행기-구현) [근거](work/s5-design-system-v2/plan.md#savev3-타입과-v2-이전-구현) 2026-09-24 기능 계약의 미확정 문장 10개를 닫았다. [근거](work/s5-design-system-v2/plan.md#기능-계약의-미확정-문장-정리)
