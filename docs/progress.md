...
5. 반복 표현에서 컴포넌트 계약을 추출한다. 2026-09-23 [UI 컴포넌트 계약](specs/ui-components.md) 초안 22개를 작성하고 기존 Figma 자산을 재사용·수정·신규로 판정했다. 2026-09-23 수정 6개와 C-02를 Figma에 반영했다. [근거](work/s5-design-system-v2/plan.md#ui-컴포넌트-수정-6개-figma-반영) 같은 날 신규 C-06~C-25를 만들었다. [근거](work/s5-design-system-v2/plan.md#ui-신규-컴포넌트-figma-반영) 템플릿도 수정했다. [근거](work/s5-design-system-v2/plan.md#템플릿-수정) 05 Screens도 갱신하고 V2 문제 12개 중 11개를 처리했다. [근거](work/s5-design-system-v2/plan.md#05-screens-갱신과-v2-문제-처리) 남은 것은 V2-04 그림·데이터와 와이어프레임 전체의 고해상도 조립이다. 2026-09-23 모듈 책임과 저장 구조를 [모듈 계약](specs/modules.md)으로 정했다. [근거](work/s5-design-system-v2/plan.md#모듈-책임과-저장-구조-설계)
