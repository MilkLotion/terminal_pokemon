...
6. 모듈 책임과 저장 구조는 [모듈 계약](specs/modules.md)으로 정했다. 2026-09-23 거래·저장의 남은 값과 이로치 약의 소모 단위를 정했다. [근거](work/s5-design-system-v2/plan.md#저장과-거래의-남은-값-확정) 2026-09-24 종별 성장 속도·종족값·진화 단계·수집 난이도와 진화 조건을 생성 도구로 만들어 `data/`에 채웠다. [근거](work/s5-design-system-v2/plan.md#콘텐츠-데이터-생성) 남은 데이터는 알 행동 조건의 종별 표와 도구별 가격이다.
