...
flowchart LR
  ...
  A10 --> C10["Figma v2 시각 기준 00~05<br/>탭: 파티·도감·상점·가방<br/>헤더: 포인트·업적창·설정 아이콘<br/>파티 탭 안 박스 목록, 그 안 돌보미집<br/>우클릭·트레이 메뉴 구성<br/>저해상도 와이어프레임 WF-01~08 작성"]
  A10 --> O10["박스 목록 안 돌보미집 세부 배치<br/>와이어프레임 검토·컴포넌트 계약<br/>Figma 열린 문제 12개, 탭 구성 반영<br/>창 크기·배율 정책"]
