...
6. 모듈 책임과 저장 구조는 [모듈 계약](specs/modules.md)으로 정했다. 2026-09-23 거래·저장의 남은 값과 이로치 약의 소모 단위를 정했다. [근거](work/s5-design-system-v2/plan.md#저장과-거래의-남은-값-확정) 다음은 콘텐츠 데이터를 `data/`에 채우는 일이다.
